...
* Note we have provided a port mapping of 80:80, the number of the left of the colon indicates the host port and the number on the right is the container port. By default Nginx is set to port 80
